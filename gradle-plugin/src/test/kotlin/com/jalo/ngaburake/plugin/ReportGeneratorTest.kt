...
class ReportGeneratorTest {
    ...
    fun `console format berisi satu baris pass-fail per finding`() {
        ...
        assertTrue(output.contains("[FAIL] com.jalo.ngaburake.PaymentManager"))
        assertTrue(output.contains("[PASS] com.jalo.ngaburake.ApiKeyStore"))
    }
    ...
    fun `json format berisi schema minimal target type severity detail`() {
        ...
        assertTrue(output.contains("\"target\": \"com.jalo.ngaburake.PaymentManager\""))
